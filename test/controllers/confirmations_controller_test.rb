...
class ConfirmationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create confirmation" do
    assert_difference('Confirmation.count') do
      post confirmations_url, params: { confirmation: { name: @confirmation.name, quantity: @confirmation.quantity, telephone: @confirmation.telephone } }
    end
  ...
  test "should update confirmation" do
    patch confirmation_url(@confirmation), params: { confirmation: { name: @confirmation.name, quantity: @confirmation.quantity, telephone: @confirmation.telephone } }
